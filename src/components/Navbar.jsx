  ...
  <div className="container">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink className="nav-link text-black" to="/service">Services</NavLink>
        </li>
        <li className="nav-item">
        ...
        <NavLink className="navbar-brand fw-bolder fs-4 mx-auto text-black" to="/">FINE ART</NavLink>
        ...
        <NavLink to="/dashboard" className="btn btn-outline-primary ms-2 px-4 rounded-pill text-black">
            <i className="fa fa-user-plus me-2 "></i>Dashboard</NavLink>
        <NavLink to="/logout" className="btn btn-outline-primary ms-2 px-4 rounded-pill text-black">
